...
class App(ttk.Frame):
    ...
    def setup_widgets(self):
        ...
        self.check_2 = ttk.Checkbutton(
            self.check_frame, text="Checked", variable=self.var_1, command=self.printer
        )
        self.check_2.grid(row=1, column=0, padx=5, pady=10, sticky="nsew")

        self.button_start1 = ttk.Button(self.check_frame, text="Third state", command=self.if_nor)
        self.button_start1.grid(row=2, column=0, padx=5, pady=10, sticky="nsew")
        ...
        self.monitoring.insert(tk.CURRENT, "Press \"Start Monitoring\" Button to start!")
        ...
        #self.entry2 = tk.Entry(self.pane2_2, width=30)
        #self.entry2.grid(row=1, column=1, padx=(420, 10), pady=(20, 10), sticky="nsew")

        # Tab #4
        self.tab_EventLog = ttk.Frame(self.notebook)
        self.notebook.add(self.tab_EventLog, text="CSV_Reader")
