...
class App(ttk.Frame):
    ...
    def setup_widgets(self):
        ...
        tv = ttk.Treeview(self.tab_EventLog, columns=('col_1', 'col_2', 'col_3','col_4'), show='headings')
        tv.column('col_1', minwidth=0, width=400)
        tv.column('col_2', minwidth=0, width=100)
        tv.column('col_3', minwidth=0, width=100)
        tv.column('col_4', minwidth=0, width=100)
        
        tv.heading('col_1', text='TITLE')
        tv.heading('col_2', text='YEAR')
        tv.heading('col_3', text='IMDBID')
        tv.heading('col_4', text='IMDBID')
        
        tv.pack()
        for (q,w,e,r) in csvreader_list:
            tv.insert('', 'end', values=(q,w,e,r))
        f.close()
        # Tab #5
